...
function optionsframework_options() {
	...
	$options[] = array(
	 ...
	 $options[] = array(
		'desc' => __('<a href="'.esc_url(SKT_URL).'" target="_blank"><img src="'.get_template_directory_uri().'/images/sktskill.jpg"></a><p><em><a target="_blank" href="'.esc_url('http://sktthemes.net/themes/iamone-pro/', 'skt-iamone').'">Buy PRO version for only $39 with more features.</a></em></p>', 'skt-iamone'),
		'type' => 'info');	
